    ...
    <div id="slides-shop" class="cover-slides">
        <ul class="slides-container">
            <li class="text-center">
                <img src="images/banner-01a.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> Locamart</strong></h1>
                            <p class="m-b-40">locamart is a online shopping website for urban and rural handicraft all over handicraft all over gujarat state.</p>
                        </div>
                    </div>
                </div>
            </li>
            <li class="text-center">
                <img src="images/banner-02b.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> Locamart</strong></h1>
                            <p class="m-b-40">we develop this website with the aim of uplifting the handicraft item for <br> small scale industries of which people have forgot the importance.</p>
                        </div>
                    </div>
                </div>
            </li>
            <li class="text-center">
                <img src="images/banner-03b.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> Locamart</strong></h1>
                            <p class="m-b-40">locamart is a online shopping website for urban and rural <br> handicraft all over handicraft all over gujarat state.</p>
                        </div>
                    </div>
                </div>
            </li>
