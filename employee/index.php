...
if(isset($_POST['loginbtn']))
{
  ...
  $employee_email=$_POST['employeeName'];
  $employee_password=$_POST['employeePassword'];

  $seclt_admin="SELECT * from employee WHERE employee_email='$employee_email' and employee_pass='$employee_password'";
  ...
  <div class="inner-warpper text-center">
    ...
    <form action="" method="POST" id="formvalidate">
      <div class="input-group">
        ...
        <input class="form-control" name="employeeName" id="employeeName" type="text" placeholder="Enter email" required />
        <span class="lighting"></span>
      </div>
      <div class="input-group">
        
        <input class="form-control" name="employeePassword" id="employeePassword" type="password" placeholder="Enter passsword "required  />
        <span class="lighting"></span>
      </div>
      <br>
      ...
      <div class="clearfix supporter">
        ...
        <a class="forgot pull-right" href="register.php" style="color:#b0b435;">create one</a>
      </div>
